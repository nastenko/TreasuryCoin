...
/**
  ...
  */
class TPowMiner(viewHolderRef: ActorRef, settings: HybridMiningSettings) extends Actor with ScorexLogging {
  ...
  private val getRequiredData: GetDataFromCurrentView[TreasuryHistory,
    ...
    PowMiningInfo] = {
    val f: CurrentView[TreasuryHistory, TBoxStoredState, TWallet, SimpleBoxTransactionMemPool] => PowMiningInfo = {
